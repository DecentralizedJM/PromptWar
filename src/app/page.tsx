...
export default function Home() {
  ...
  return (
    <main className="flex h-screen w-full bg-[#fafaf8] text-[#1a2744] overflow-hidden">
      ...
      <div className="flex-1 flex flex-col items-center overflow-y-auto pb-32 pt-10 px-4 sm:px-12 relative w-full">
              ...
              <div className="space-y-6 pb-12 w-full">
                ...
                <div className="grid grid-cols-1 gap-6 w-full relative z-0">
                  {activeResults.map((card, idx) => (
                    <StructuredCardView key={card.id || idx} card={card} allCards={activeResults} />
                  ))}
                </div>
              </div>
            ) : (
